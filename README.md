...
| 🤖 **GenAI** — Generative AI Production | 12 | Higgsfield (image/video), ElevenLabs (voice/audio), Suno (music) |
...
| Consumer Insight Researcher | Personas, surveys, focus groups, journey mapping |
| Media Planner | Channel strategy, budget allocation, CPM/GRP |
| PR Writer | Press releases, media kits, crisis communications |
| Social Content Creator | Content calendars, platform-native posts |
| Pitch Deck Builder | Client presentations, agency credentials |
