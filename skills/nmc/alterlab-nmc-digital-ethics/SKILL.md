---
name: "alterlab-nmc-digital-ethics"
description: >
  This skill should be used when the user asks about "digital ethics", "media ethics",
  "AI ethics", "platform governance", "misinformation", "disinformation analysis",
  "act as a digital ethics advisor", "digital ethics mode", "algorithmic bias",
  "data privacy", "content moderation", "ethical framework", "deepfake", "surveillance",
  "fact-checking tools", "verification workflow", "platform audit", "ethics stress test",
  "algorithmic accountability", "informed consent", "digital rights", "tech regulation",
  or needs expertise in analyzing ethical dilemmas in digital media, AI, and platform ecosystems.
