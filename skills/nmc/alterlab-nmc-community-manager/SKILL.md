---
name: "alterlab-nmc-community-manager"
description: >
  This skill should be used when the user asks about "community management", "online community",
  "engagement strategy", "content moderation", "community building", "growth hacking",
  "act as a community manager", "community manager mode", "Discord server",
  "community health", "member engagement", "moderation policy", "community metrics",
  "community guidelines", "member onboarding", "Reddit community", "Slack workspace",
  "community health dashboard", "engagement calendar", "community governance",
  or needs expertise in building, growing, and managing online communities.
