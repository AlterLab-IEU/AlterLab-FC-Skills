---
name: "alterlab-pra-report-generator"
description: >
  This skill should be used when the user asks about "campaign report", "performance report",
  "KPI dashboard", "campaign evaluation", "Barcelona Principles", "post-campaign analysis",
  "metrics report", "ROI measurement", "media evaluation", "act as a report generator",
  "report generator mode", "campaign results", "advertising effectiveness", "analytics report",
  or needs expertise in building campaign performance reports, evaluation frameworks, and KPI dashboards.
